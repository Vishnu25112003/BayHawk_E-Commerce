...
const orders = [
  {
    ...
    total: 1299,
    items: [
      { name: "Fresh Pomfret", quantity: 2, image: "/placeholder.svg" },
      { name: "Tiger Prawns", quantity: 1, image: "/placeholder.svg" },
    ],
  },
  {
    id: "FC1234567891",
    ...
    status: "Delivered",
    total: 599,
    items: [{ name: "King Fish Steaks", quantity: 1, image: "/placeholder.svg" }],
  },
  {
    id: "FC1234567892",
    date: "2025-01-10",
    status: "Cancelled",
    total: 749,
    items: [{ name: "Seafood Combo", quantity: 1, image: "/placeholder.svg" }],
  },
]

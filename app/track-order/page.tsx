              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <Badge className="bg-[#0A4D8C]/10 text-[#0A4D8C]/80">Out for Delivery</Badge>
                  </div>
                </CardHeader>
                <CardContent>
                  {/* Timeline */}
                    ...
                    {trackingSteps.map((step, index) => (
                      <div key={step.status} className="flex gap-4 pb-8 last:pb-0">
                        ...
                        {index < trackingSteps.length - 1 && (
                          <div
                            className={cn(
                              "absolute w-0.5 h-full left-4 top-8",
                              step.completed ? "bg-primary" : "bg-border",
                            )}
                            style={{ height: "calc(100% - 32px)", top: `${index * 80 + 32}px` }}
                          />
                        )}
                        ...
                        >
                          {step.completed ? <CheckCircle className="h-5 w-5" /> : <Clock className="h-4 w-4" />}
                        </div>

                        {/* Content */}
                        <div className="flex-1">
                          <p className={cn("font-semibold", step.current && "text-primary")}>{step.title}</p>

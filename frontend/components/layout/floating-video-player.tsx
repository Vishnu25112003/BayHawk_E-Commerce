  ...
  return (
    <div
      className={cn(
        ...
        isExpanded 
          ? "bottom-4 left-4 w-[70vw] h-[70vw] md:w-[450px] md:h-[450px]" 
          : "bottom-6 left-6 w-[240px] h-[240px] md:w-[300px] md:h-[300px]"
      )}
    >
        ...
        <div className="relative w-full h-full rounded-2xl overflow-hidden border-2 border-white/10 backdrop-blur-sm">
          ...
          <div className="absolute top-0 left-0 right-0 p-3 flex items-center justify-between bg-gradient-to-b from-black/70 to-transparent z-10">
            <div className="flex items-center gap-2">
              <Badge className="bg-red-600 hover:bg-red-600 text-white text-xs font-bold px-2 py-0.5 animate-pulse">
                LIVE
              </Badge>
              {!isExpanded && (
            ...
            <div className="flex items-center gap-1">
              <Button
                variant="ghost"
                size="icon"
                className="h-8 w-8 bg-white/10 hover:bg-white/20 text-white rounded-lg backdrop-blur-md transition-all"
                onClick={(e) => {
                  e.stopPropagation()
                  toggleExpand()
                }}
              ...
              <Button
                variant="ghost"
                size="icon"
                className="h-8 w-8 bg-white/10 hover:bg-red-500/80 text-white rounded-lg backdrop-blur-md transition-all"
                onClick={(e) => {
                  e.stopPropagation()
                  handleClose()
                }}
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-9 w-9 bg-white/10 hover:bg-white/20 text-white rounded-lg backdrop-blur-md transition-all"
                  onClick={(e) => {
                    e.stopPropagation()
                    togglePlay()
                  }}

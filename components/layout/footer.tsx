      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-full md:col-span-1 lg:col-span-1 flex justify-center md:justify-start items-center">
            <img src="https://bayhawk.clientstagingdemo.com/_next/static/media/BayHawk.207595da.svg" alt="BayHawk Logo" className="h-20 w-auto" />
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-background/20">
          ...
          {/* Copyright */}
          <div className="mt-8 text-center text-sm text-background/60">

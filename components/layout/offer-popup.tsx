      ...
      <DialogContent className="max-w-[calc(100%-2rem)] sm:max-w-md md:max-w-lg p-0 gap-0 overflow-hidden border-0 max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-gradient-to-b from-gray-50 to-white p-4 sm:p-6 md:p-8">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
            <Button
              className="flex-1 h-10 sm:h-12 text-sm sm:text-base font-semibold bg-gradient-to-r from-[#0A4D8C] to-[#0d5fa3] hover:from-[#083d6f] hover:to-[#0A4D8C]"
              onClick={() => {
                setIsOpen(false)
            ...
            <Button
              variant="outline"
              className="flex-1 h-10 sm:h-12 text-sm sm:text-base font-semibold border-2 border-[#0A4D8C] text-[#0A4D8C] hover:bg-[#0A4D8C] hover:text-white"
              onClick={() => setIsOpen(false)}
            >
              Maybe Later
            </Button>

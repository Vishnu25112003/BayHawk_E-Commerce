              ...
              {images.map((img, index) => (
                <button
                  ...
                  className={cn(
                    ...
                    selectedImage === index ? "border-[#0A4D8C]" : "border-gray-200",
                  )}
                >
                  <img
          ...
          <div className="flex flex-col space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2 p-2 bg-secondary rounded-lg">
              <div className="text-center">
                ...
                <p className="font-semibold text-xs">{product.pieces}</p>
              </div>
              <div className="text-center border-x border-border">
                <p className="text-xs text-muted-foreground mb-0.5">Serves</p>
                <p className="font-semibold text-xs">{product.serves}</p>
              </div>
              <div className="text-center">
                <p className="text-xs text-muted-foreground mb-0.5">Weight</p>
                <p className="font-semibold text-xs">{selectedWeight}</p>
              </div>
            </div>
